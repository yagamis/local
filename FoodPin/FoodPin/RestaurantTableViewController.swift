...
class RestaurantTableViewController: UITableViewController,NSFetchedResultsControllerDelegate,UISearchResultsUpdating {
    ...
    override func viewDidLoad() {
        ...
        sc.searchBar.placeholder = NSLocalizedString("输入餐馆名搜索...", comment: "搜索占位符")
...
//    }
    ...
    */
    ...
    override func tableView(tableView: UITableView, editActionsForRowAtIndexPath indexPath: NSIndexPath) -> [UITableViewRowAction]? {
        let 分享行为 = UITableViewRowAction(style: .Default, title: NSLocalizedString("分享", comment: "分享按钮标题")) { (action, indexPath) -> Void in
            
            let alert = UIAlertController(title: NSLocalizedString("分享到", comment: "分享菜单标题"),message: NSLocalizedString("请选择您要分享的社交类型", comment: "分享菜单副标题"), preferredStyle: .ActionSheet)
            
            let qqAction = UIAlertAction(title: "qq",style: .Default, handler: nil)
            let weiboAction = UIAlertAction(title: NSLocalizedString("微博", comment: "新浪微博"),style: .Default, handler: nil)
            let wxAction = UIAlertAction(title: NSLocalizedString("微信", comment: "腾讯微信"),style: .Default, handler: nil)
